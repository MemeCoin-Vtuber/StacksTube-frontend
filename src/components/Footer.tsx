    ...
    <footer className="bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <img
                ...
                className="w-8 h-8"
              />
              <span className="font-bold text-xl">StacksTube</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="https://twitter.com/Stackstube"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://discord.gg/Stackstube"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-yellow transition-colors flex items-center gap-2"
                >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>
            &copy; {new Date().getFullYear()} StacksTube. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
